			...
			try {
				...
				synchronized( queue ) {
					...
					if((level == 0) && (slice[level] == 1)) {
						slice[level] = 0;
						//still more left to execute so remove from q0 and add to tail of q1
					...
					//level = 1 & slice = 2
						...
						slice[level] = 0;
						//still more left to execute so remove from q1 and add to tail of q2
					...
					//level = 2	& slice = 4
						...
						slice[level] = 0;
						//still more left to execute so remove from q2 and add to tail of q2
